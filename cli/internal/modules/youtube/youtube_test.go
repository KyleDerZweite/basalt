...
<meta property="og:description" content="Some bio text">
<meta property="og:image" content="https://example.com/avatar.jpg">
<link rel="canonical" href="https://www.youtube.com/@testuser">
</head>
<body></body>
</html>`
...
func TestExtractFound(t *testing.T) {
	...
	if nodes[1].Label != "Test User" {
		t.Errorf("expected label 'Test User', got %q", nodes[1].Label)
	}
	...
	if nodes[2].Label != "https://example.com/avatar.jpg" {
