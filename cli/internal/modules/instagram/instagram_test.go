...
<meta property="og:description" content="500 Followers, 100 Following">
<meta property="og:image" content="https://example.com/ig-avatar.jpg">
</head>
<body></body>
</html>`
...
func TestExtractFound(t *testing.T) {
	...
	if nodes[1].Label != "Test User (@testuser)" {
		t.Errorf("expected label 'Test User (@testuser)', got %q", nodes[1].Label)
	}
	...
	if nodes[2].Label != "https://example.com/ig-avatar.jpg" {
